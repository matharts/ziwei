...
export type Contract = [
  Assert<Equal<Birth, Design.Birth>>,
  Assert<Equal<Parameters, Design.Parameters>>,
  Assert<Equal<Profile, Design.Profile>>,
  Assert<Equal<ZiweiErrorDetail, Design.ZiweiErrorDetail>>,
  Assert<Equal<Natal, Design.Natal>>,
  Assert<Equal<Palace, Design.Palace>>,
  Assert<Equal<Star, Design.Star>>,
  Assert<Equal<SelfTransformations, Design.SelfTransformations>>,
  Assert<Equal<DecadeAgeRange, Design.DecadeAgeRange>>,
  Assert<Equal<Zodiac, Design.Zodiac>>,
  Assert<Equal<FiveElementBureau, Design.FiveElementBureau>>,
  Assert<Equal<PalaceName, Design.PalaceName>>,
  Assert<Equal<StarName, Design.StarName>>,
  Assert<Equal<StarCategory, Design.StarCategory>>,
  Assert<Equal<StarGalaxy, Design.StarGalaxy>>,

...
test('the packed package loads from an independent consumer without install scripts', t => {
  ...
  execFileSync('pnpm', ['exec', 'tsc', '--ignoreConfig', '--noEmit', '--strict', '--noUncheckedIndexedAccess',
    '--exactOptionalPropertyTypes', '--module', 'NodeNext', '--target', 'ES2022', esmSource, cjsSource],
